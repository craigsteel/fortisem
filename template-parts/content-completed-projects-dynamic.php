<?php
/**
 * The template for displaying latest completed projects feed
 *
...
<section class="completed-projects">
    ...
    <?php
      $args = array(
        ...
        'category_name'  => 'projects', // category slug
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="more">
         <a href="<?php echo home_url() ?>/category/projects"> SEE ALL PROJECT ></a>
      </div>
